...
class Align(nn.Cell):
    """
    Convolution 2D used int Temporal Convolution Layer and Graph Convolution Layer.
    """
...
class CausalConv2d(nn.Cell):
    """
    Convolution 2D used int temporal Convolution Layer.
    """
...
class TemporalConvLayer(nn.Cell):
    ...
    def construct(self, x):
        """
        start temporal Convolution Layer.
        """
...
class OutputBlock(nn.Cell):
    ...
    def construct(self, x):
        """
        start the computation of network, in order to get output.
        """
